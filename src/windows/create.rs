...
lazy_static! {
    static ref WINDOWS: Mutex<HashMap<u32, Window>> = Mutex::new(HashMap::new());
}

pub fn create_window(id: u32, title: &str, width: u32, height: u32, x: i32, y: i32) -> HWND {
    unsafe {
        ...
        WINDOWS.lock().unwrap().insert(id, Window {
            id,
